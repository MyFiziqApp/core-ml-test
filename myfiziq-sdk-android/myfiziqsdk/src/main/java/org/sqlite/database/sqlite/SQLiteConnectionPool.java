...
public final class SQLiteConnectionPool implements Closeable
{
    ...
    private void dispose(boolean finalized) {
        ...
        if (!finalized) {
            ...
            synchronized (mLock) {
                ...
                if (pendingCount != 0) {
                    //Timber.i("The connection pool for " + mConfiguration.label
    ...
    private boolean recycleConnectionLocked(SQLiteConnection connection,
        ...
        if (status == AcquiredConnectionStatus.RECONFIGURE) {
            try {
                ...
                //Timber.e("Failed to reconfigure released connection, closing it: "
                //        + connection, ex);
    ...
    void onConnectionLeaked() {
        ...
        //Timber.w("A SQLiteConnection object for database '"
    ...
    private void closeConnectionAndLogExceptionsLocked(SQLiteConnection connection) {
        try {
            ...
            //Timber.e(ex, "Failed to close connection, its fate is now in the hands "
    ...
    private void reconfigureAllConnectionsLocked() {
        if (mAvailablePrimaryConnection != null) {
            try {
                ...
                //Timber.e(ex, "Failed to reconfigure available primary connection, closing it: "
        ...
        for (int i = 0; i < count; i++) {
            ...
            try {
                ...
                //Timber.e(ex, "Failed to reconfigure available non-primary connection, closing it: "
                //        + connection);
                closeConnectionAndLogExceptionsLocked(connection);
    ...
    private void finishAcquireConnectionLocked(SQLiteConnection connection, int connectionFlags) {
        try {
            ...
            //Timber.e("Failed to prepare acquired connection for session, closing it: "
