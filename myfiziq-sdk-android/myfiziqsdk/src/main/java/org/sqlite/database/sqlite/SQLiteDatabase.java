...
public final class SQLiteDatabase extends SQLiteClosable
{
    ...
    private void open() {
        try {
            ...
            //Timber.e(ex, "Failed to open database '" + getLabel() + "'.");
            close();
            throw ex;
        }
    }
    ...
    public long replace(String table, String nullColumnHack, ContentValues initialValues) {
        try {
            ...
            //Timber.e(e, "Error inserting " + initialValues);
            return -1;
        }
    }
    ...
    public boolean enableWriteAheadLogging() {
        synchronized (mLock) {
            ...
            if (mConfigurationLocked.isInMemoryDb()) {
                //Timber.i("can't enable WAL for memory databases.");
                return false;
            }
            ...
            if (mHasAttachedDbsLocked) {
                //Timber.d("this database: " + mConfigurationLocked.label
            ...
            for (int i = 0; i < attachedDbs.size(); i++) {
                ...
                try {
                    ...
                    if (!rslt.equalsIgnoreCase("ok")) {
                        ...
                        //Timber.e("PRAGMA integrity_check on " + p.second + " returned: " + rslt);
                        return false;
                    }
                } finally {
