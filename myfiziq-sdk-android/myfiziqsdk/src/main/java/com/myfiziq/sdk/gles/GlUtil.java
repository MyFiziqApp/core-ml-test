...
public class GlUtil
{
    ...
    public static void logVersionInfo() {
        //Timber.i("vendor  : " + GLES20.glGetString(GLES20.GL_VENDOR));
        //Timber.i("renderer: " + GLES20.glGetString(GLES20.GL_RENDERER));
        //Timber.i("version : " + GLES20.glGetString(GLES20.GL_VERSION));
        ...
        if (false) {
            ...
            if (GLES30.glGetError() == GLES30.GL_NO_ERROR) {
                //Timber.i("iversion: " + majorVersion + "." + minorVersion);
            }
        }
    }
}
