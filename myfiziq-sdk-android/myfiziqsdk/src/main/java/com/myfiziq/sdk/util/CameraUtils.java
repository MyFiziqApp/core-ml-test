...
public class CameraUtils
{
    ...
    public static void choosePreviewSize(Camera.Parameters parms, int width, int height) {
        ...
        if (ppsfv != null) {
            //Timber.d("Camera preferred preview size for video is " +
            //        ppsfv.width + "x" + ppsfv.height);
        }

        //for (Camera.Size size : parms.getSupportedPreviewSizes()) {
        //    Timber.d("supported: " + size.width + "x" + size.height);
        //}
        ...
        //Timber.w("Unable to set preview size to " + width + "x" + height);
        if (ppsfv != null) {
    ...
    public static int chooseFixedPreviewFps(Camera.Parameters parms, int desiredThousandFps) {
        ...
        for (int[] entry : supported) {
            //Timber.d("entry: " + entry[0] + " - " + entry[1]);
        ...
        //Timber.d("Couldn't find match for " + desiredThousandFps + ", using " + guess);
        return guess;
    }
}
