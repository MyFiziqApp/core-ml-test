...
public class TrackFragmentPager extends FragmentPagerAdapter
{
    ...
    public TrackFragmentPager(Activity activity, FragmentManager childFragmentManager, ViewPager pager)
    {
        super(childFragmentManager);
        init(activity, pager, null);
    }

    public TrackFragmentPager(Activity activity, FragmentManager childFragmentManager, ViewPager pager, TabLayout tablayout)
    {
        super(childFragmentManager);
    ...
    private class TabInfo
    {
        ...
        public TabInfo(Class fragmentClass, Bundle args)
        {
            ...
            if (null != args && args.containsKey(BaseFragment.BUNDLE_PARAMETERS))
            {
                ...
                if (null != set && set.hasParam(com.myfiziq.sdk.R.id.TAG_TITLE))
                {
                    Parameter param = set.getParam(com.myfiziq.sdk.R.id.TAG_TITLE);
                    if (null != param)
                    {
