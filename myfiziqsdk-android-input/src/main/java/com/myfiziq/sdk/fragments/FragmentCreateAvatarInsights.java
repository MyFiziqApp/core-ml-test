...
import com.myfiziq.sdk.EthnicityPickerDialog;
...
public class FragmentCreateAvatarInsights extends BaseFragment implements FragmentInterface, FragmentHomeInterface, CursorHolder.CursorChangedListener
{
    public EditText ethnicityEditText;
    ...
    private EthnicityPickerDialog ethPicker = new EthnicityPickerDialog();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        if (willSoonClose())
        {
            Timber.i("%s won't be rendered since the fragment will soon close", FragmentCreateAvatarInsights.class.getSimpleName());
            return null;
        }
        ...
        ethnicityEditText = view.findViewById(R.id.ethEditText);
        ethnicityEditText.setFocusableInTouchMode(false);
        ethnicityEditText.setOnClickListener(v ->
        {
            FragmentManager fragmentManager = getFragmentManager();
            if (fragmentManager != null)
            {
                ethPicker.show(fragmentManager, "");
                ethPicker.linkedEditText = ethnicityEditText;
            }
        });
    ...
    protected int getFragmentLayout()
    {
        ...
        {
            return R.layout.fragment_create_avatar_insights;
        }
        else
        {
    ...
    {
        String ethnicityString = MyFiziqLocalUserDataHelper.getValue(LocalUserDataKey.ETHNICITY);
        ...
        try
        {
            int ethnicityInt = Integer.parseInt(ethnicityString);
            ethnicityEditText.setText(InsightsFormulas.getEthnicityDisplayFromNumber(ethnicityInt, getResources()));
            ethPicker.chosenEthnicity = ethnicityInt;
        }
    ...
    private boolean validate()
    {
        ...
        if (TextUtils.isEmpty(ethnicityEditText.getText()))
        {
            ethnicityEditText.setError("Please select your ethnicity");
            return false;
        }
    ...
    private void onContinueClicked()
    {
        ...
        if (validate())
        {
            ...
            MyFiziqLocalUserDataHelper.setValue(LocalUserDataKey.ETHNICITY, Integer.toString(ethPicker.chosenEthnicity));
    ...
    private void openGuestSelector()
    {
        ...
        if (set != null)
        {
            ...
            set.addParam(new Parameter(R.id.TAG_ARG_ETHNICITY, ethPicker.chosenEthnicity));
        }
